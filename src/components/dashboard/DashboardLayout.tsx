...
import { LayoutDashboard, Inbox, Briefcase, LogOut, Home, Sparkles, Store, Settings, BadgeCheck, CalendarDays, ListChecks, BookHeart } from "lucide-react";
...
const items = [
  ...
  { title: "Vendor lists", url: "/dashboard/vendor-lists", icon: BookHeart },
